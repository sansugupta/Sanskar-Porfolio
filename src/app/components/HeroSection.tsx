...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-[50] w-full mx-auto px-8 md:px-16 lg:px-24 text-center">
        <motion.div
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#14a800]/10 border border-[#14a800]/30 text-[#14a800] text-sm font-mono hover:bg-[#14a800]/20 transition-colors cursor-pointer"
          >
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 mb-4"
        >
